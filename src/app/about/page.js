  ...
  return (
    <div className="max-w-6xl mx-auto space-y-4 p-4">
      ...
      <p>
        ...
        inspire, and provoke thought. Our dedicated team of film enthusiasts is
        committed to providing you with unbiased and engaging reviews that delve
        deep into the heart of each film. We aim to offer a platform where you
        can find valuable information and make informed decisions about what to
        watch.
      </p>
      <p>
        With a vast library of reviews spanning various genres and eras, we
        strive to cater to diverse tastes and preferences. From Hollywood
        blockbusters to independent gems, we take pride in exploring the full
        spectrum of cinematic experiences. Our reviews not only focus on the
        technical aspects of filmmaking but also delve into the narrative,
